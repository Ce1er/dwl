...
static const MonitorRule monrules[] = {
    ...
    */
    ...
    { "DP-4", 0.55f, 1,      1,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL, 0,    0,   1920, 1080, 240.0f, 1,   1},
    { "DP-3", 0.5f,  1,      1,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL, 1920, 195, 1600, 900,  60.0f,  0,   0},
